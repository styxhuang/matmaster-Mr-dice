...
# Database host configuration from environment variables
DB_CORE_HOST = os.getenv("DB_CORE_HOST", "https://db-core.dp.tech")
BOHRIUM_CORE_HOST = os.getenv("BOHRIUM_CORE_HOST", "https://bohrium-core.dp.tech")

# User ID from environment variable
x_user_id = os.getenv("BOHRIUM_X_USER_ID", "117756")
